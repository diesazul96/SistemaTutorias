            ...
            if (opcionIntro == 1) {
                do {
                    ...
                    if (opcionTipoProfe == 1) {
                        ...
                        ProfesorPlanta pp = new ProfesorPlanta(nombreProfesor, identificacionProfesor);
                        ...
                        String identificacionProfesor = lec.next();
                        ProfesorCatedra pc = new ProfesorCatedra(nombreProfesor, identificacionProfesor);
